...
public class EmpServiceIntegrationTests {
	...
	public void addEmployeeTest() throws Exception {
		...
		Mockito.when(employeeService.addEmployee(empRequest)).thenReturn(employee);

		mockMvc.perform(MockMvcRequestBuilders.post("/employee/addEmployee/").content(employeeAsJsonString)
	...
	void updateEmployeeTest() throws Exception {
		...
		ObjectMapper objectMapper = new ObjectMapper();
		String employeeAsJsonString = objectMapper.writeValueAsString(empRequest);
		Mockito.when(employeeService.updateEmployee(empRequest)).thenReturn(employee);
